      ...
      {isSubmitted ? (
        ...
        <>
          <div className="flex justify-center gap-2 sm:flex-col sm:gap-2">
            ...
            <button className={cn(formElemStyles.default, formElemStyles.solid, isSubmitting && 'opacity-60 hover:opacity-60 cursor-not-allowed')} onClick={handleSubmit} disabled={isSubmitting}>
